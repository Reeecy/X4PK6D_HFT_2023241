    ...
    public class Tester
    {
        ...
        public void Init()
        {
            ...
            personsList = new List<Person>()
            {
                ...
                new Person { Id = 6, FirstName = "Test6", LastName = "Test6", DateOfBirth = new DateTime(2000, 3, 15), Address = "456 Maple St", PhoneNumber = "555-9876", Email = "test6@gmail.com", IsStudent = true, IsRetired = false, PassId = 3, Pass = passesList.ToList()[2], EntriesExits = entriesExitsList.OrderBy(x => Guid.NewGuid()).Take(5).ToList() },
                ...
                new Person { Id = 12, FirstName = "Test12", LastName = "Test12", DateOfBirth = new DateTime(2001, 9, 15), Address = "456 Fir St", PhoneNumber = "555-8765", Email = "test12@gmail.com", IsStudent = true, IsRetired = false, PassId = 0, Pass = passesList.ToList()[0], EntriesExits = entriesExitsList.OrderBy(x => Guid.NewGuid()).Take(5).ToList() },
