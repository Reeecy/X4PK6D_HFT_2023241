    ...
    public class Tester
    {
        ...
        public void Init()
        {
            ...
            personsList = new List<Person>()
            {
                ...
                new Person { Id = 6, FirstName = "6", LastName = "Test6", DateOfBirth = new DateTime(2000, 3, 15), Address = "456 Maple St", PhoneNumber = "555-9876", Email = "test6@gmail.com", IsStudent = true, IsRetired = false, PassId = 0, Pass = passesList.ToList()[0], EntriesExits = new List<EntriesExits>(){ new EntriesExits { Id = 21 } } },
        ...
        public void PersonsWithEntriesExitsTest()
        {
            ...
            // Assert
            Assert.AreEqual(personsList.Where(x => x.EntriesExits.Count > 0).Count(), result.Count());
        }
